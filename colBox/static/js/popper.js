...
!(function(e, t) {
        ...
        return r === W ?
                ...
                (function(e) {
                    ...
                    return (
                        ...
                        ((i = o.width),
                            ...
                            ((s = o.offsetLeft), (f = o.offsetTop))), { width: i, height: a, x: s + l(e), y: f }
                    );
                })(e)
            ) :
            n(r) ?
            ...
            V(
                (function(e) {
                    ...
                    return (
                        "rtl" === d(o || n).direction &&
                        (f += i(n.clientWidth, o ? o.clientWidth : 0) - a), { width: a, height: s, x: f, y: p }
                    );
                })(u(e))
            );
    }
    ...
    function I(e, t, o) {
        var s =
            ...
            (function(e) {
                var t = b(g(e)),
                    o = ["absolute", "fixed"].indexOf(d(e).position) >= 0 && r(e) ?
                    O(e) :
                    e;
                return n(o) ?
                    t.filter(function(e) {
                    ...
                    a = T.reduce(function(e, n) {
                        return (
                            (e[n] = (function(e, t, n) {
                                ...
                                return (
                                    (a = a || 0),
                                    (s = (s || 0) * o), [A, D].indexOf(r) >= 0 ? { x: s, y: a } : { x: a, y: s }
                                );
                            })(n, t.rects, i)),
                            e
                        );
